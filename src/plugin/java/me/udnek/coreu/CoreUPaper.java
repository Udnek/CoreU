...
@NullMarked
public final class CoreUPaper extends JavaPlugin implements ResourcePackablePlugin{

    private static final RpHost rpHost = new RpHost();

    @Override
    public void onEnable() {
        CoreU.setPluginInstance(this);
        ...
        // horizon bridge
        //HorizonBridge.instance = new HorizonBridge(a -> a*2);
    }
