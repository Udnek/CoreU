...
@org.jspecify.annotations.NullMarked public class LoreBuilder{
    ...
    public void set(int priority, LoreBuilder.@Nullable Componentable componentable){
        if (componentable == null) lore.remove(priority);
        else lore.put(priority, componentable);
    }
    public void set(Position position, LoreBuilder.@Nullable Componentable componentable){
        set(position.priority, componentable);
    }
    public LoreBuilder.@Nullable Componentable get(int priority){
        return lore.get(priority);
    }
    public LoreBuilder.@Nullable Componentable get(Position position){
