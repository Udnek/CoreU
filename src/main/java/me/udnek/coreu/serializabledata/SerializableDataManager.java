...
@org.jspecify.annotations.NullMarked public class SerializableDataManager{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public static <T extends SerializableData> T read(@NonNull T data, Plugin plugin, Player player){
        String readRaw = readRaw(getPath(data, plugin, player));
        data.deserialize(readRaw);
        return data;
    }
    public static <T extends SerializableData> T read(@NonNull T data, Plugin plugin){
    ...
    public static void loadConfig() {
        config = CoreU.getPlugin().getConfig();
    }
    public static void saveConfig() {
        CoreU.getPlugin().saveConfig();
    }
}
