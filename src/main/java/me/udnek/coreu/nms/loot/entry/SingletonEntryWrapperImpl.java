...
//    public static @Nullable SingletonEntryWrapperImpl fromVanillaByPredicate(LootTable lootTable, Predicate<ItemStack> predicate){
...
//                if (predicate.test(itemStack)) return new SingletonEntryWrapperImpl( container);
//            }
//        }
//        return null;
//    }

    public SingletonEntryWrapperImpl(@Nullable PoolWrapper parent, LootPoolSingletonContainer container) {
    ...
    protected net.minecraft.world.item.@Nullable ItemStack extractExplorerMap(){
