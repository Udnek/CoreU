...
@NullMarked public abstract class RPGUItemAbstractAbility<ActivationContext> extends AbstractComponentHolder<RPGUItemAbility<?>>implements RPGUItemAbility<ActivationContext>{
    ...
    public void activate(CustomItem customItem,
                         ...
                         @NonNull ActivationContext activationContext)
    {
    ...
    @Override
    public void activate(CustomItem customItem, LivingEntity livingEntity, UniversalInventorySlot slot, @NonNull ActivationContext activationContext){
    ...
    protected abstract ActionResult action(CustomItem customItem, LivingEntity livingEntity,
                                           UniversalInventorySlot slot, @NonNull ActivationContext activationContext);
