...
public class RPGUComponents {
    ...
    static {
        ...
        ABILITY_COOLDOWN_TIME = register(new AttributeBasedPropertyType("rpgu_ability_cooldown_time", RPGUAttributes.COOLDOWN_TIME, -1, "ability.rpgu.cooldown_time"));
        ABILITY_CAST_RANGE = register(new AttributeBasedPropertyType("rpgu_ability_cast_range", RPGUAttributes.CAST_RANGE, -1, "ability.rpgu.cast_range"));
        ABILITY_AREA_OF_EFFECT = register(new AttributeBasedPropertyType("rpgu_ability_area_of_effect", RPGUAttributes.AREA_OF_EFFECT, -1, "ability.rpgu.area_of_effect"));
        ABILITY_DURATION = register(new AttributeBasedPropertyType("rpgu_ability_duration", RPGUAttributes.ABILITY_DURATION, -1, "ability.rpgu.duration", true));
