...
@NullMarked public class PropertyFunctions{
    ...
    public static <Context, Value extends Number> RPGUPropertyFunction<Context, Value> CONSTANT(@NonNull Value value){
        return new RPGUPropertyFunction<>() {
            ...
            @Override
            public @NonNull Value getBase() {
                return value;
            }

            @Override
            public @NonNull Value apply(@NonNull Context context) {
                return value;
            }
    ...
    public static <Context> RPGUPropertyFunction<Context, Integer> CEIL(RPGUPropertyFunction<Context, Double> function){
        return new RPGUPropertyFunction<>() {
            ...
            @Override
            public Integer apply(@NonNull Context context) {
    ...
    public static <In> RPGUPropertyFunction<In, Double> LINEAR(RPGUPropertyFunction<In, Double> x, RPGUPropertyFunction<In, Double> base, RPGUPropertyFunction<In, Double> perX){
        return new RPGUPropertyFunction<>() {
            ...
            @Override
            public Double apply(@NonNull In v) {
