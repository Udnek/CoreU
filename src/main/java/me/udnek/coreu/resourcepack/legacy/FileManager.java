...
public class FileManager{
    ...
    public static boolean isFile(Class<?> clazz, String path){
        ...
        return RpFileType.get(removeSlashes(resource.getPath())) != RpFileType.UNKNOWN;
    }
    ...
    public static List<String> getAllResources(Class<?> clazz, String path){
        path = removeSlashes(path) + "/";
        @Nullable String[] allResources = getAllResourcesInternal(clazz, path);
    ...
    private static @Nullable String[] getAllResourcesInternal(Class<?> clazz, String path){
