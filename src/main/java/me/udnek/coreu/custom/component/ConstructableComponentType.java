        ...
        implements CustomComponentType<HolderType, Component>, Translatable
{
    ...
    public ConstructableComponentType(String rawId, Component defaultComponent, Supplier<Component> componentCreator){
        this.rawId = rawId;
    ...
    public ConstructableComponentType(String rawId, Component defComponent){
    ...
    @Override
    public Component createNewDefault() {
