...
public class MiddleClickableEntity extends MiddleClickable implements CustomComponent<CustomEntityType>{
    ...
    private final @Nullable CustomItem itemRepresentation;

    public MiddleClickableEntity(@Nullable CustomItem itemRepresentation){
        this.itemRepresentation = itemRepresentation;
    }

    public void onMiddleClick(CustomEntityType entity, PlayerPickEntityEvent event){
        if (itemRepresentation == null) return;
        onMiddleClick(itemRepresentation, event);
    }
